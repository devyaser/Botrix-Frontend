    ...
    <Layout>
      <div className="max-h-[calc(100vh-96px)] flex-1 flex">
        <div className="w-[275px] p-2 lg:block hidden">
          <div className="border-b border-custom-border p-2 pr-4">
            <button
              className="btn normal-case text-base btn-block bg-custom-primary hover:bg-custom-primary text-white border-custom-primary hover:border-custom-primary"
        ...
        <div className="flex-1 p-2 flex flex-col">
          <div className="mb-2 w-full relative">
            <input
              ...
              className="input w-full bg-black border border-custom-border text-custom-gray"
              onClick={handleOpenSearchModal}
            />
            <div className="text-custom-gray absolute top-0 h-full right-3 flex flex-col justify-center">
