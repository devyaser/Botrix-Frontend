...
export default function BoardItem({
  ...
  const showMedal = () => {
    ...
    switch (idx) {
      case 1:
        medal = <Image src="/images/gold-medal.png" alt="Gold Medal" width={20} height={20} />;
        break;

      case 2:
        medal = <Image src="/images/gold-medal-2.png" alt="Gold Medal" width={20} height={20} />;
        break;

      case 3:
        medal = <Image src="/images/gold-medal-3.png" alt="Gold Medal" width={20} height={20} />;
        break;
  ...
  return (
    <tr className="rounded-[5px] overflow-hidden cursor-pointer" onClick={() => handleClick()}>
      ...
      <td className="py-5 px-0 border-b border-custom-border">
        <div className="ml-0 lg:ml-9 flex gap-2 items-center">
          ...
          <div className="w-auto lg:w-[143px] text-sm font-bold text-custom-sky">{username}</div>
        </div>
      </td>
      <td className="hidden lg:table-cell p-0 border-b border-custom-border">{showMedal()}</td>
