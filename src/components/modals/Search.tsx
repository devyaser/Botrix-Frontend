...
const links = [
  { id: 1, type: "chat", content: "consectetur adipiscing elit.", category: "trending" },
  { id: 1, type: "chat", content: "consectetur adipiscing elit.", category: "trending" },
  { id: 1, type: "keyword", content: "What is a wallet?", category: "knowledge" },
  { id: 2, type: "person", content: "Gorem ipsum", category: "trending" },
  { id: 1, type: "person", content: "Gorim ipsum", category: "popular" },
  { id: 2, type: "chat", content: "One-third of humanity remains offline", category: "popular" },
  { id: 2, type: "chat", content: "One-third of humanity remains offline", category: "popular" },
];
...
export default function SearchModal({
  ...
  return (
    <div className={cn("modal bg-custom-lightgraythree/90", open ? "modal-open" : "invisible")}>
          ...
          <div className="flex lg:justify-end mt-10 mb-[17px] lg:mb-2">
            <div className="flex">
              <div className="flex gap-0.5">
                ...
                <span className="text-[13px] font-medium text-white">Referral Program</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[7px]">
            {filtedLinks.map((link: any, idx: number) => (
              <Link
                ...
                handleClick={() => handleClickLink(link.type, link.category, link.id)}
              />
            ))}
          </div>
        </div>
