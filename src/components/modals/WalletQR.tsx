...
export default function WalletQRModal({ open, hideModal }: { open: boolean; hideModal: Function }) {
  return (
        ...
        <div className="w-[580px] m-auto mt-10 flex justify-center">
          <div className="w-[370px]">
            ...
            <div className="py-5 px-2">
              <div className="text-[20px] font-bold text-white mb-2">Connect Wallet</div>
              <div className="text-base text-white">Botrix use Binance BNB Wallet</div>
            </div>
          </div>
        </div>
      </div>
