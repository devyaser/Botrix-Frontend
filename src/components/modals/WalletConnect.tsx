      ...
      <div className="modal-box px-2 pt-[30px] pb-[90px] bg-custom-lightgraytwo no-scrollbar max-w-[700px]">
        ...
        <div className="w-[580px] m-auto mt-10 flex justify-center">
          <div className="w-[370px]">
            ...
            <div className="mb-2 bg-custom-lightgraythree px-2 py-5 rounded-[5px]">
              <div className="text-[20px] font-bold text-white mb-2">Order Details</div>
              <div className="flex justify-between">
                <div className="flex">
                  <div className="mr-2">
                    <Image src="/images/avatar-1.png" width={30} height={30} alt="Logo" />
                  </div>
            ...
            <div className="mb-2 bg-custom-lightgraythree px-2 py-5 rounded-[5px]">
              <div className="text-[20px] font-bold text-white mb-2">Order Summary</div>
              ...
              >
                <Image src="/images/Binance_Logo.png" width={30} height={30} alt="Logo" />
                Connect Wallet
              </button>
            </div>
            <div className="text-center">
              <div className="text-base font-bold text-white mb-2">What is a wallet?</div>
              <p className="text-base text-white">
                A wallet is used to send, receive, store, and display digital assets. It’s also a
                new way to login, without needing to create new accounts and passwords on every
                website.
              </p>
